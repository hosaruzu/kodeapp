    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            topView.topAnchor.constraint(
                ...
                constant: Spec.TopView.toSafeAreaOffset),
            topView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            topView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            topView.heightAnchor.constraint(
                equalToConstant: view.bounds.height / Spec.TopView.heightMultiplier),
...
private enum Spec {
    enum TopView {
        static let toSafeAreaOffset: CGFloat = -24
        static let heightMultiplier: CGFloat = 4
    }
}
